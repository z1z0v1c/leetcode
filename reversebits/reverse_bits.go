 ...
 * 	epresentation is the same, whether it is signed or unsigned.
 * 	In Java, the compiler represents the signed integers using 2's complement notation.
 * 	herefore, in Example 2 above, the input represents the signed integer -3 and the
 * 	utput represents the signed integer -1073741825.
 *
 * Example 1:
 *
